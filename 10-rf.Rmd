...
Note that the data read from preprocessing is saved in an `.Rdata` file. This is likely not necessary for most projects, but due to the variety in descriptors used, this saves time in the other model-building examples. The same occurs for data from RFE. 
