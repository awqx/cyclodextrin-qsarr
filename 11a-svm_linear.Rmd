...
saveRDS(svm_linear_allvar_df, "result/trn/all_var/rf.RDS")
saveRDS(svm_linear_rfe_df, "result/trn/rfe_var/rf.RDS")
```

```{r, eval = T, echo = F}
svm_linear_allvar_df <- readRDS("result/trn/all_var/rf.RDS")
svm_linear_rfe_df <- readRDS("result/trn/rfe_var/rf.RDS")
